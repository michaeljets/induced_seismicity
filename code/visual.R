...
water = read.csv("data/final_water.csv")
eqs = read.csv("data/final_eqs.csv")
blocks = read.table("data/final_blocks.txt")[ , 1]
...
for (i in 1:length(blocks)){
  ...
  # save plots
  path_save = paste0("pictures/eq_inj25/not_cumm/", "grid", blocks[i], ".jpeg")
...
###############################################################################  
  ...
  # save plots
  path_save = paste0("pictures/eq_inj25/cumm/", "grid", blocks[i], ".jpeg")
  jpeg(filename = path_save,
       width = 1500, height = 600)
